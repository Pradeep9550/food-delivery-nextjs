...
export default function EditItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(result.data, " item/edit-item")
    ...
    useEffect(() => {
        const handleGetItemById = async () => {
            try {
                ...
                console.log(result.data,  "item/get-by-id")
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#fff9f6]">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">You need to have a shop to edit items</p>
                </div>
            </div>
        );
    }
