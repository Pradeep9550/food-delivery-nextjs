...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    updateOrderStatus: (state, action) => {
      ...
      if(order && order.shopOrders?.shop?._id===shopId) order.shopOrders.status = status;
    },
...
export const {
  ...
  setMyOrders, addMyOrder, updateOrderStatus, updateRealtimeOrderStatus,
  setSearchItems, setTotalAmount, setSocketConnected, setSocketId
} = userSlice.actions;
